		...
		>
			...
			<div class="w-full h-full flex items-center justify-center flex-col">
				<div class="inputBox flex flex-col w-full justify-center items-center">
					<div class="flex justify-start w-4/5 text-slate-700 text-lg pb-2"><p>Email</p></div>
					<input
				...
				<div class="inputBox flex flex-col w-full justify-center items-center mt-8">
					<div class="flex justify-start w-4/5 text-slate-700 text-lg pb-2"><p>Password</p></div>
					<input
